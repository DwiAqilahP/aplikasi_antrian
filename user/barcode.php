...
$formulirURL = 'http://localhost/antrian_fix/user/formulir.php?id_antrian=' . $id_antrian;

// Membuat barcode menggunakan library PHPQRCode
QRcode::png($formulirURL, 'barcode.png', QR_ECLEVEL_L, 10);

// Menampilkan gambar barcode
echo '<img src="barcode.png" alt="Barcode">';
?>
